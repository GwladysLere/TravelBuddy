...
<?php if ($_POST['partie_modif'] == "trajet")
{ ?>
	<h1> Modification des informations du trajet </h1>
	<form action="verif_modif_trajet.php" method="post" class="form_inscription" >
		<fieldset>
		...
		<input type="hidden" name="id_trajet" value="<?php echo $_POST['id_trajet']; ?>" />
